              ...
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="number" name="product_camera" class="form-control" placeholder="Enter Product Camera">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Ram</label>
		        		<input type="number" name="product_ram" class="form-control" placeholder="Enter Product Ram">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Storage</label>
		        		<input type="number" name="product_storage" class="form-control" placeholder="Enter Product Storage">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Battery</label>
		        		<input type="number" name="product_battery" class="form-control" placeholder="Enter Product Battery">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group">
                <label>Product Image 2 <small>(format: jpg, jpeg, png)</small></label>
                <input type="file" name="product_image2" class="form-control">
                <input type="hidden" name="hidden_product_image2">
                <img src="../product_images/1.0x0.jpg" class="img-fluid" width="50">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Product Image 3 <small>(format: jpg, jpeg, png)</small></label>
                <input type="file" name="product_image3" class="form-control">
                <input type="hidden" name="hidden_product_image3">
                <img src="../product_images/1.0x0.jpg" class="img-fluid" width="50">
              </div>
            </div>
