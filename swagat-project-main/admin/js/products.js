$(document).ready(function(){
	...
	$(document.body).on('click', '.edit-product', function(){
		...
		$("input[name='product_ram']").val(product.product_ram);
		$("input[name='product_storage']").val(product.product_storage);
		$("input[name='product_battery']").val(product.product_battery);
		$("input[name='product_price']").val(product.product_price);
		$("input[name='product_camera']").val(product.product_camera);
		$("input[name='hidden_product_image']").val(product.product_image);
		$("input[name='hidden_product_image2']").val(product.product_image2);
		$("input[name='hidden_product_image3']").val(product.product_image3);
		$("input[name='e_product_image']").siblings("img").attr("src", "../product_images/"+product.product_image);
		$("input[name='product_image2']").siblings("img").attr("src", "../product_images/"+product.product_image2);
		$("input[name='product_image3']").siblings("img").attr("src", "../product_images/"+product.product_image3);
